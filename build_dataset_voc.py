...
class ConvertCoco(object):
    ...
    def __call__(self, image, target):
        ...
        #classes = torch.tensor([self.class_mapping[c] for c in classes], dtype=torch.int64)
...
num_workers=2
square_div_64=True
train_dataset=build_dataset(img_folder, ann_file, image_set,batch_size,num_workers,square_div_64)"""# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 19:51:20 2024
